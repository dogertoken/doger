        const maxSupply = 10000000000; // 10 Miliar Token

// Gunakan RPC Resmi dari OPNB Testnet
const rpcURL = "https://opbnb-testnet-rpc.bnbchain.org";
const web3 = new Web3(new Web3.providers.HttpProvider(rpcURL));

// Ganti dengan alamat kontrak token Anda
const contractAddress = "0xf70C807DEE3bc21eb7732919Edcca4d290083474";

// ABI Minimum untuk membaca total supply & minted supply
...
// Inisialisasi Chart.js dengan efek gradient 3D
const ctx = document.getElementById('donutChart').getContext('2d');
let donutChart;

function createGradient(ctx) {
    let gradient = ctx.createLinearGradient(0, 0, 0, 400);
    gradient.addColorStop(0, "#FFA500"); // Orange Atas
    gradient.addColorStop(1, "#FF4500"); // Red Orange Bawah
    return gradient;
}
...
// Update Chart saat ada perubahan minting
async function updateChart() {
    try {
        ...
        console.error("Gagal mengambil data minting:", error);
    }
}
